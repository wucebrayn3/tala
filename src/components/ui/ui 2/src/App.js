    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={isAuthenticated ? <Flashcard /> : <Navigate to="/login" replace />}
        />
        <Route
        ...
        <Route
          ...
          element={isAuthenticated ? <CreateFlashcard /> : <Navigate to="/login" replace />}
        />
        <Route
          path="/flashcard-set/:setId" // New route for viewing a specific set
          element={isAuthenticated ? <FlashcardSetView /> : <Navigate to="/login" replace />}
        />
